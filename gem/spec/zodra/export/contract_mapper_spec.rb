...
RSpec.describe Zodra::Export::ContractMapper do
  ...
  describe "#generate" do
    ...
    it "includes nested resources" do
      ...
      contract.find_action(:index).tap { |a| a.http_method = :get; a.path = "/invoices/:invoice_id/line_items" }
    ...
    it "generates multiple contracts" do
      ...
      contract.find_action(:index).tap { |a| a.http_method = :get; a.path = "/customers" }
